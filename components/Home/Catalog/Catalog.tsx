	...
	return (
		<div className={styles.catalog_container}>
			...
			<div data-route={route} className={styles.btn_wrapper}>
				{route === '/' ? (
					<Button onClick={() => router.push(`/categories`)} buttonType='primary' className={styles.view_more} data-type={type}>
						<h3>View more drinks</h3>
					</Button>
				) : (
					<Button onClick={() => router.push(`/categories/alcohol`)} buttonType='primary' className={styles.view_more} data-type={type}>
						<h3>View more drinks</h3>
					</Button>
				)}
			</div>
