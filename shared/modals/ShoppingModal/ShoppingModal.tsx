  ...
  return (
    <ModalElement bodyClass={styles.modalBodyClass} isOpen={isOpen} onClose={onClose} modalImage='/svgs/modal-Image2.svg'>
        <div className={styles.modal_body}>
            ...
            <p>
                Take your friends to the shop with you. 
                Have them add drinks to your cart and have fun telling them no 
                if you do not like the drinks they added to your cart.
            </p>
            ...
            <div className={styles.tabcontent_container}>
                {activeTab === 1 && 
                    <div className={styles.newGroup_tab}>
                        <div className={styles.email_inputField}>
                            <InputField label='Enter friends emails' type='email' 
                                placeholder='Enter email, separate with comma' 
                            />
                        </div>
                ...
                {activeTab === 2 && 
                    <div className={styles.shopping_tab}>
                        <Accordion image='/svgs/janedoe.svg' type='small'
                            title='created 2 months ago'
                            iconType='chevron'
                        >
