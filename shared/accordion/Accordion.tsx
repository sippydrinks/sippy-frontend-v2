...
const Accordion = ({ title, type, image, iconType, children }: AccordionProps) => {
	...
	return (
		<div data-type={type} data-theme={theme} data-active={isOpen} data-icontype={iconType} className={styles.accordionContainer}>
			<div className={styles.accordionHeaderContainer}>
				...
				<div onClick={OpenAccordion} data-type={iconType} data-active={isOpen} className={`${styles.accordionPlusIcon} ${styles.accordionChevronIcon}`}>
